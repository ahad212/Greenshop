                    ...
                    <tbody>
                        @foreach ($getdata as $key => $datas)
                            <tr>
                                ...
                                <td>{{$datas->phone}}</td>
                                <td>{{$datas->role}}</td>
                                <td>{{$datas->blockuser}}</td>
                                <td>
                                    <a href="{{route('editusers',$datas->id)}}" class="btn btn-info" style="color:white;" title="Edit"><i class="far fa-edit"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
