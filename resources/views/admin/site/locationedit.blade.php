...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css" integrity="sha512-nMNlpuaDPrqlEls3IX/Q56H36qvBASwb3ipuo3MxeWbsQB1881ox0cRv7UPTgBlriqoynt35KjEwgGUeUXIPnw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <form action="{{route('location.update',$location->id)}}" method="POST" style="width:90%;margin:auto;">
        @csrf
        @method('PUT')
        <div class="row row-cols-1 row-cols-lg-2">
            <div class="col">
                <label for="cname" class="d-block" style="font-weight:bold;">
                    Name
                    <input type="text" id="cname" value="{{$location->name}}" class="form-control" name="name" >
                </label>
                <label for="cname" class="d-block"  style="font-weight:bold;">
                    Email
                    <input type="text" id="cname" value="{{$location->shippingcost}}" class="form-control" name="cost" >
                </label>
