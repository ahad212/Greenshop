...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav" style="margin-bottom:70px;">
                            ...
                            <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link {{ ('laraecomm/admin/product/brand' === request()->path())? 'active' : ''}}" href="{{route('category')}}">Category</a>
                                </nav>
                            </div>
        ...
        <script>
            let ordermanage = document.getElementById('ordercover');
            let usermanage = document.getElementById('usercover');
            let sitemanage = document.getElementById('sitecover');
            let getwaymanage = document.getElementById('getwaycover');
            ...
            if (role == 'admin') {
                ...
                getwaymanage.style.display='none';

            } else {
                usermanage.style.display='block';
                sitemanage.style.display='block';
                getwaymanage.style.display='block';                
            }
            if (role == 'seller') {
            ...
            function logout() {
                ...
                window.location.href=`/laraecomm/${logout}/login`;
            }             
