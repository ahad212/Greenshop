...
@section('main_content')
    ...
    <form action="{{route('insertproduct')}}" method="POST" style="width:90%;margin:auto;" enctype="multipart/form-data">
        @csrf
        <div class="row row-cols-1 row-cols-lg-2">
            ...
            <div class="col">
                ...
                <div class="status_wrapping">
                    ...
                    <div class="check_wrapping" style="display: flex;grid-column-gap:10px;">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="sactive" value="active" id="flexRadioDefault1" checked>
